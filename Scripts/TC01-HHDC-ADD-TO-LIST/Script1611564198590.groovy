...
WebUI.click(findTestObject('Object Repository/Page_Hn h, cho thu ngi yu p, hen ho, thue n_ad7527/path (1)'))
...
WebUI.click(findTestObject('Object Repository/Page_Chn PG  PB cho bui hn ca bn/a_Xem_1'))

WebUI.click(findTestObject('Object Repository/Page_Nguyn Vn Khanh hn h ti  Nng/a_a vo danh sch chn'))

WebUI.click(findTestObject('Object Repository/Page_Nguyn Vn Khanh hn h ti  Nng/button_ng'))
